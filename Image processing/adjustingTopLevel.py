...
class AdjustingTopLevel(Toplevel):
    ...
    def __init__(self, master=None):
        ...
        self.brightness_label = Label(self, text="Яскравість")
        self.brightness_scale = Scale(self, from_=0, to_=2, length=250, resolution=0.1,
                                      orient=HORIZONTAL)
        self.r_label = Label(self, text="Червоний")
        self.r_scale = Scale(self, from_=-100, to_=100, length=250, resolution=1,
                             orient=HORIZONTAL)
        self.g_label = Label(self, text="Зеленій")
        self.g_scale = Scale(self, from_=-100, to_=100, length=250, resolution=1,
                             orient=HORIZONTAL)
        self.b_label = Label(self, text="Синій")
        self.b_scale = Scale(self, from_=-100, to_=100, length=250, resolution=1,
                             orient=HORIZONTAL)
        self.kernelSize_label = Label(self, text="Розмір сітки")
        self.kernelSize_scale = Scale(self, from_=1, to_=np.gcd(width, height), length=250, resolution=1,
                                      orient=HORIZONTAL)
        self.gammaSize_label = Label(self, text="Гамма")
        self.gammaSize_scale = Scale(self, from_=0.1, to_=10.0, length=250, resolution=0.1,
                                     orient=HORIZONTAL)
        self.clipLimitSize_label = Label(self, text="Clip Limit")
        self.clipLimitSize_scale = Scale(self, from_=2.0, to_=15.0, length=250, resolution=0.1,
                                         orient=HORIZONTAL)

        self.histogram_button = Button(self, text="Вирівнювання гістограми", width=20, font="ariel 11 bold")
        self.erosion_button = Button(self, text="Ерозія", width=10, font="ariel 11 bold")
        self.dilation_button = Button(self, text="Розширення", width=10, font="ariel 11 bold")
        self.opening_button = Button(self, text="Відкриття", width=10, font="ariel 11 bold")
        self.closing_button = Button(self, text="Закриття", width=10, font="ariel 11 bold")
        self.gradient_button = Button(self, text="Градієнт", width=10, font="ariel 11 bold")
        self.topHat_button = Button(self, text="Циліндр", width=10, font="ariel 11 bold")
        self.blackHat_button = Button(self, text="Затемнення", width=10, font="ariel 11 bold")
        self.ellipse_button = Button(self, text="Еліпс", width=10, font="ariel 11 bold")
        self.rect_button = Button(self, text="Рект", width=10, font="ariel 11 bold")
        self.cross_button = Button(self, text="Хрестик", width=10, font="ariel 11 bold")
        self.power_law_button = Button(self, text="Степеневий закон (гама)", width=20, font="ariel 11 bold")
        self.apply_button = Button(self, text="Зберегти",width=7)
        self.preview_button = Button(self, text="Перегляд",width=7)
        self.cancel_button = Button(self, text="Скасувати",width=7)
        self.clear_button = Button(self, text="Очистити",width=7)
        ...
        self.erosion_button.place(x=15, y=300)
        self.dilation_button.place(x=140, y=300)
        self.opening_button.place(x=15, y=340)
        self.closing_button.place(x=140, y=340)
        self.gradient_button.place(x=15, y=380)
        self.topHat_button.place(x=140, y=380)
        self.blackHat_button.place(x=15, y=420)
        self.ellipse_button.place(x=140, y=420)
        self.rect_button.place(x=15, y=460)
        self.cross_button.place(x=140, y=460)
        self.clipLimitSize_label.place(x=90, y=540)
        self.clipLimitSize_scale.place(x=0, y=560)
        self.histogram_button.place(x=33, y=600)
        self.gammaSize_label.place(x=95, y=640)
        self.gammaSize_scale.place(x=0, y=660)
        self.power_law_button.place(x=33, y=700)
        self.cancel_button.place(x=0, y=740)
        self.clear_button.place(x=82, y=740)
        self.preview_button.place(x=137, y=740)
        self.apply_button.place(x=197, y=740)
