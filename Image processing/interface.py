...
class Interface(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.resize_button = Button(self, text="Розміри", bg="black", fg='white', width=10, font="ariel 13 bold")
        self.resize_label = Label(text="Введіть X і Y", font="Arial 8 bold")
        ...
        self.flip_button = Button(self, text="Відзеркл.", bg="black", fg='white', width=10, font="ariel 13 bold")
        ...
        self.music_label.place(x=0, y=75)
        ...
        self.rotate_label.place(x=497)
        self.rotate_entry.place(x=490, y=25)
        self.rotate_button.place(x=480, y=45)
        self.saveRotation_button.place(x=525, y=45)
        self.resize_label.place(x=615)
        ...
        self.flip_button.place(x=895)
        self.contrast_button.place(x=895, y=45)
